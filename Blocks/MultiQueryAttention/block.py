...
class MultiQueryAttention(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        tokenized, downsampled, w_q, w_kv, w_p, feature_map, projections_modified, value, attention, key, query = ctx.saved_tensors
        ...
        d_w_p = projections_modified.transpose(1,2) @ d_tokens # (h*v, C)
